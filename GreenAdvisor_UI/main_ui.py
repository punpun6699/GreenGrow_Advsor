    ...
    def setupUi(self, Form):
      ...
      #  self.label_Precipitation_Q2.setStyleSheet(font_label)
       ...
       # self.textEdit_Precipitation_Q2.setStyleSheet(font_input)
        ...
        self.textEdit_Phosphorus.setStyleSheet(font_input)

        self.label_Potassium = QtWidgets.QLabel(Form)
        self.label_Potassium.setGeometry(QtCore.QRect(40, 400, 140, 30))
        self.label_Potassium.setText("Potassium:")
        ...
        self.pushButton_cal.setText("Calculate")
        ...
        self.pushButton_cls.setText("Clear")
        ...
        self.pushButton_data.setText("Load Data")
        self.pushButton_data.setStyleSheet(font_button + font_button_hover)
